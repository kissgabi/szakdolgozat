 ...
 * @author b6dmin
 */
public class XxXx01Sprite extends Thread {

    static XxXx00Control c;
    ...
    public XxXx01Sprite(Image image, String name, String target) {
    ...
    private void sleepThread(long sleepTime) {
        try {
            ...
            Logger.getLogger(XxXx01Sprite.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
